...
| `media/Codex-Micro-Glass-Guide.srt` | English captions for the four-minute cut | `be9129ee6ab83f1b55bd31243a16757440df26c4aa0d8955e0ea9586671cc4aa` |
...
- The final media is the approved HeyGen `Codex Micro Glass Guide` four-minute launch film.
- The approved long-form narration is recorded in `launch/HeyGen-Substack-Narration.md`.
- The superseded three-minute edit remains documented in `launch/HeyGen-GitHub-3-Minute-Narration.md`, `launch/HeyGen-GitHub-3-Minute-Storyboard.md`, and `launch/composite-github-cut.sh` for provenance.
- Personal Codex task names, links, and identifiers are not present in the public media or template.

## Release revision

- Restored the approved 4:32 HeyGen launch film after the shorter GitHub edit.
- Kept the stable media filename so existing links continue to work.
- Replaced the companion captions with the matching four-minute caption track.
...
- Captions match the four-minute cut and end at `04:32.470`.
